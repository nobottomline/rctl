...
connecting, and requires confirmation before replacing a saved endpoint.
Discovery is not authentication. See `protocol/discovery-v1.md` and
`docs/MOBILE-LAN.md`; protected local pairing remains behind a separate gate.
